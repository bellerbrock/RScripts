...
A  full NCSU yield dataset is downloaded from sweetpotatobase through the wizard. It's imported and filtered to keep only measurements for material that was still active in the program in 2018. Then yield is calculated on a per plant basis to account for different plot sizes in different trials

```{r}
library(dplyr)
yielddat = read.csv("/home/bryan/projects/RScripts/08-18yieldandweatherHCRCUN.csv", header=T)
